...
export const DashboardScheduleCalendar = ({
    ...
    currentDate: ISODate;
    currentWeek: number;
    getLogoSrc: (schoolName: string) => string | undefined;
    ...
    return (
        <div style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: 6, marginBottom: 6 }}>
                {dayNames.map((d, i) => (
                    <div key={`${d}-${i}`} style={{ textAlign: 'center', color: mutedInk, fontSize: 11, fontWeight: 800 }}>
                        {d}
                    </div>
                ))}
            </div>
                ...
                {monthGrid.map(cell => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {userGame && (() => {
                                const logoSrc = getLogoSrc(userGame.opponent);
